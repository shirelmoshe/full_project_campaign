...
CREATE PROCEDURE [dbo].[spUser_Update]
 @userId INT ,@userName NCHAR (50), @cellphoneNumber NCHAR (50), @email NCHAR (50), @twitterUsername NCHAR (50), @UserType NCHAR (50)
AS
begin 
update dbo.[User]
	SET userName=@@userName,cellphoneNumber=@cellphoneNumber,email=@email,twitterUsername=@twitterUsername,UserType=@UserType where userId=@userId
end
GO
