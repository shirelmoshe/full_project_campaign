...
GO
PRINT N'Altering Table [dbo].[Campaing]...';


GO
ALTER TABLE [dbo].[Campaing] ALTER COLUMN [img] NVARCHAR (MAX) NOT NULL;
...
GO
PRINT N'Refreshing Procedure [dbo].[spCampaing_Delete]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spCampaing_Delete]';


GO
PRINT N'Refreshing Procedure [dbo].[spCampaing_Get]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spCampaing_Get]';


GO
PRINT N'Refreshing Procedure [dbo].[spCampaing_GetAll]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spCampaing_GetAll]';


GO
PRINT N'Refreshing Procedure [dbo].[spCampaing_Update]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spCampaing_Update]';
